...
## Tree Example
If we needed to implement an algorithm that requires use of post-order and
pre-order traversals of a tree, like the 
[Reingold-Tilford algorithm](https://reingold.co/tidier-drawings.pdf) we can
